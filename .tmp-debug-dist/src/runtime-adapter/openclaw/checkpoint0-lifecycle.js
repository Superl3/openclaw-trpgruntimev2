...
function normalizeSession(session) {
    ...
    const lastActionSummary = readString(session.lastActionSummary) || null;
    const normalized = {
        ...session,
        sceneId,
        ownerId,
...
export function registerCheckpoint0LifecycleTools(api) {
    ...
    api.logger.info("[trpg-runtime] checkpoint1 lifecycle tools registered: trpg_session_new, trpg_session_resume, trpg_session_end, trpg_session_verbose, trpg_panel_interact, trpg_panel_message_commit");
}
