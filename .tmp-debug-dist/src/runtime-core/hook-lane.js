...
function normalizeShortText(raw, defaultText) {
...
function normalizeOverrides(overrides, input) {
...
export function validateQuestHookTextOutput(value) {
    return isQuestHookTextOutput(value) ? value : null;
}
export class RuleBasedQuestHookTextRenderer {
    invoker;
    constructor(invoker) {
