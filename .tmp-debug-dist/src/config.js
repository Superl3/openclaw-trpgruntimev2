...
import { DEFAULT_RUNTIME_SAFETY_FLAGS, normalizeRuntimeSafetyFlags, } from "./runtime-core/safety-flags.js";
...
export function parseTrpgRuntimeConfig(raw) {
    ...
    const legacyRichHookTextEnabled = typeof obj.richHookTextEnabled === "boolean" ? obj.richHookTextEnabled : undefined;
    const runtimeSafetyFlags = normalizeRuntimeSafetyFlags({
        behavioralDriftEnabled: readBoolean(obj.behavioralDriftEnabled, DEFAULT_RUNTIME_SAFETY_FLAGS.behavioralDriftEnabled),
        behavioralDriftAffectsRules: readBoolean(obj.behavioralDriftAffectsRules, DEFAULT_RUNTIME_SAFETY_FLAGS.behavioralDriftAffectsRules),
        anchorLifecycleEnabled: readBoolean(obj.anchorLifecycleEnabled, DEFAULT_RUNTIME_SAFETY_FLAGS.anchorLifecycleEnabled),
        anchorSummaryOnly: readBoolean(obj.anchorSummaryOnly, DEFAULT_RUNTIME_SAFETY_FLAGS.anchorSummaryOnly),
        richHookActionableEnabled: readBoolean(obj.richHookActionableEnabled, legacyRichHookTextEnabled ?? DEFAULT_RUNTIME_SAFETY_FLAGS.richHookActionableEnabled),
        richHookWorldPulseEnabled: readBoolean(obj.richHookWorldPulseEnabled, legacyRichHookTextEnabled ?? DEFAULT_RUNTIME_SAFETY_FLAGS.richHookWorldPulseEnabled),
        richHookRecentOutcomesEnabled: readBoolean(obj.richHookRecentOutcomesEnabled, DEFAULT_RUNTIME_SAFETY_FLAGS.richHookRecentOutcomesEnabled),
        ...
        canonicalWriteBackEnabled: readBoolean(obj.canonicalWriteBackEnabled, DEFAULT_RUNTIME_SAFETY_FLAGS.canonicalWriteBackEnabled),
        recommendationWhimEnabled: readBoolean(obj.recommendationWhimEnabled, DEFAULT_RUNTIME_SAFETY_FLAGS.recommendationWhimEnabled),
    });
    const richHookTextEnabled = runtimeSafetyFlags.richHookActionableEnabled || runtimeSafetyFlags.richHookWorldPulseEnabled;
    return {
        worldRoot,
        allowPatchApply,
        maxReadBytes: readInteger(obj.maxReadBytes, DEFAULT_CONFIG.maxReadBytes, 4_096, 1_048_576, "maxReadBytes"),
        maxFilesPerQuery: readInteger(obj.maxFilesPerQuery, DEFAULT_CONFIG.maxFilesPerQuery, 1, 200, "maxFilesPerQuery"),
        maxOperationsPerPatch: readInteger(obj.maxOperationsPerPatch, DEFAULT_CONFIG.maxOperationsPerPatch, 1, 200, "maxOperationsPerPatch"),
        ...
        panelDispatchTtlSec: readInteger(obj.panelDispatchTtlSec, DEFAULT_CONFIG.panelDispatchTtlSec, 30, 3600, "panelDispatchTtlSec"),
        analyzerMemoryTtlSec: readInteger(obj.analyzerMemoryTtlSec, DEFAULT_CONFIG.analyzerMemoryTtlSec, 60, 86_400, "analyzerMemoryTtlSec"),
        richHookTextEnabled,
        hookTextTimeoutMs: readInteger(obj.hookTextTimeoutMs, DEFAULT_CONFIG.hookTextTimeoutMs, 80, 2_000, "hookTextTimeoutMs"),
        hookTextCacheTtlSec: readInteger(obj.hookTextCacheTtlSec, DEFAULT_CONFIG.hookTextCacheTtlSec, 60, 7_200, "hookTextCacheTtlSec"),
...
export function assertAgentAllowed(cfg, ctx) {
